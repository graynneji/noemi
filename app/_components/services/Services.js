    ...
    <>
      <section className={styles.servicesContainer}>
        ...
        <p className={styles.servicesParah}>
          Big or small, we are ready to keep your accounting transition
          seamless. We offer a range of accounting services that are adaptable
          to your business needs. Our services include, and are not limited to:
        </p>
